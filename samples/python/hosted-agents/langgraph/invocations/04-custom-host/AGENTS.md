...
This project is a Microsoft Foundry hosted agent built with LangGraph and the Invocations protocol.

## Key files

- `azure.yaml` - Foundry hosted-agent manifest
- `src/langgraph-custom-host-invocations/main.py` - custom request adapter and graph
- `src/langgraph-custom-host-invocations/Dockerfile` - container definition
