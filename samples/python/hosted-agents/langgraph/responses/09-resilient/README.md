...
See [main.py](src/langchain-azure-resilient-responses/main.py) for the graph,
...
Create `src/langchain-azure-resilient-responses/.env`:
...
```powershell
Copy-Item .\src\langchain-azure-resilient-responses\.env.example .\.env
```
