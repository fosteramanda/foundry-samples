...
- `src/langgraph-human-in-the-loop-responses/main.py` — exported LangGraph graph factory
- `src/langgraph-human-in-the-loop-responses/langgraph.json` — graph entrypoint configuration
- `src/langgraph-human-in-the-loop-responses/Dockerfile` — container definition
