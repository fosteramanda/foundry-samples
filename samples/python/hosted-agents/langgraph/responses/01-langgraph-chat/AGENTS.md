...
- `src/langgraph-chat-responses/main.py` — exported LangGraph graph
- `src/langgraph-chat-responses/langgraph.json` — graph entrypoint configuration
- `src/langgraph-chat-responses/Dockerfile` — container definition
