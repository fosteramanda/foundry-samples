...
- `src/langgraph-workflows-responses/main.py` — exported LangGraph graph factory
- `src/langgraph-workflows-responses/langgraph.json` — graph entrypoint configuration
- `src/langgraph-workflows-responses/Dockerfile` — container definition
