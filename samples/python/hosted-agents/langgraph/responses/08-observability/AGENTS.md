...
- `src/langgraph-observability-responses/main.py` — exported LangGraph graph factory
- `src/langgraph-observability-responses/langgraph.json` — graph entrypoint configuration
- `src/langgraph-observability-responses/Dockerfile` — container definition
