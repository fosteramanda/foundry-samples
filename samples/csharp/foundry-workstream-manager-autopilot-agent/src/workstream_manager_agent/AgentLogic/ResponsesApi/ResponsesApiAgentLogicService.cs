...
public class ResponsesApiAgentLogicService : IAgentLogicService
{
    ...
    public async Task NewActivityReceived(ITurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    {
        ...
        // Teams posts machinery into a meeting chat as ordinary message activities: lifecycle
        // events with no text at all, recording-status XML (<URIObject type="Video.2/
        // CallRecording.1"><RecordingStatus .../>), and call metadata JSON carrying callId and
        // scopeId. None of it is addressed to anyone. Answering it put
        // "I can't respond because the message content is empty" into a live meeting chat in
        // front of everyone, twice.
        //
        // An earlier version of this guard only checked for blank text AND no attachments, which
        // caught almost none of it: the recording payloads have text, and the blank ones carry
        // attachments. Recognise the payloads themselves.
