...
builder.Services.AddSingleton<ITelemetryInitializer, AgenticColleague.Services.FoundryInstanceTelemetryInitializer>();
...
app.MapGet("/", () => "Hello World from AgenticColleagueAgent!");

app.MapGet("/liveness", () => "Hello World from AgenticColleagueAgent!");

app.MapGet("/readiness", () => "Hello World from AgenticColleagueAgent!");
