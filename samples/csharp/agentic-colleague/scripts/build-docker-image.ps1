...
docker build -t agentic-colleague-agent:a365preview001 `
...
docker tag agentic-colleague-agent:a365preview001 $acrLoginServer/agentic-colleague-agent:a365preview001

az acr login --name $registryName

docker push $acrLoginServer/agentic-colleague-agent:a365preview001
