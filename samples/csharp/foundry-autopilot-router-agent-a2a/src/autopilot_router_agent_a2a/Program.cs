...
app.MapGet("/", () => "Hello World from AutopilotRouterAgentA2A!");

app.MapGet("/liveness", () => "Hello World from AutopilotRouterAgentA2A!");

app.MapGet("/readiness", () => "Hello World from AutopilotRouterAgentA2A!");
