...
Set-Location "$($PSScriptRoot)/../src/autopilot_router_agent_a2a"
...
dotnet publish "./AutopilotRouterAgentA2A.csproj" -c Release -o "./publish"
...
if ([string]::IsNullOrWhiteSpace($modelDeploymentName)) {
    $appSettingsPath = Join-Path $PSScriptRoot "../src/autopilot_router_agent_a2a/appsettings.json"
