...
resource logAnalytics 'Microsoft.OperationalInsights/workspaces@2023-09-01' = {
  ...
  properties: {
    ...
    retentionInDays: 30
    // Workspace-based App Insights ingestion enforcement must match the component.
    // If the component is private but the workspace stays public, AMPLS private-link
    // ingestion is rejected ("Component private link id does not match incoming link")
    // and no telemetry lands, even from inside the VNet.
