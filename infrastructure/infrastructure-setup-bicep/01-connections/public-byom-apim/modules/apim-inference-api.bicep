...
@description('Backend Foundry account name — used to compose the public OpenAI FQDN.')
...
@description('Project region — emitted on x-aigw-region trace header.')
...
// Public OpenAI FQDN of the backend Foundry account.
